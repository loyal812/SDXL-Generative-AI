...
if __name__ == '__main__':
    ...
    # list of payload
    payload = [
    os.path.join(current_dir, "test", "regression", "rtest_img2img_url_000", "payload.json"),
    ...
    image_path = [
        os.path.join(current_dir, "test", "regression", "rtest_img2img_url_000", "output.png"),
        ...
        # os.path.join(current_dir, "test", "regression", "rtest_004", "output.png"),
        # os.path.join(current_dir, "test", "regression", "rtest_005", "output.png"),
        # os.path.join(current_dir, "test", "regression", "rtest_006", "output.png"),
        # os.path.join(current_dir, "test", "regression", "rtest_007", "output.png"),
    ]
    
    # URL
    api_url = "https://n33y73bqi4ri05-5000.proxy.runpod.net/img2img_url"
